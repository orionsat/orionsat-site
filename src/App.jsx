      ...
      <div className="bg-[#020817] text-white min-h-screen py-24 px-6 relative overflow-hidden font-sans">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <button
            ...
            className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 font-bold mb-8 md:mb-12 transition-all duration-300 group cursor-pointer hover:bg-cyan-400/10 active:scale-95 px-4 py-2 rounded-xl"
          >
          ...
          <button
            onClick={() => alternarDocumento(null)}
            className="w-full md:w-auto flex items-center justify-center gap-2 bg-white/5 border border-white/10 hover:border-cyan-400/50 hover:bg-white/10 active:scale-95 px-6 py-4 md:py-3 rounded-xl font-bold mt-12 mb-8 transition-all duration-300 cursor-pointer"
          >
      ...
      <header className="fixed top-0 left-0 w-full z-40 border-b border-white/5 backdrop-blur-2xl bg-[#020817]/70 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          <div 
            ...
            className="flex items-center gap-3 md:gap-4 hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-12 md:gap-24 items-center w-full">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 md:gap-5 mt-10">
              ...
              <a
                href="#ecossistema"
                className="w-full sm:w-auto border border-white/10 bg-white/5 backdrop-blur-sm hover:border-cyan-400/50 hover:bg-white/10 active:bg-white/20 px-8 py-4 md:py-5 rounded-2xl transition-all duration-300 font-medium text-center md:hover:-translate-y-1"
              >
                Conhecer Módulos
              </a>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8 pt-12 border-t border-white/10 mt-12 max-w-lg mx-auto lg:mx-0">
              <div className="group cursor-default">
                <h3 className="text-3xl md:text-4xl font-black text-cyan-400 md:group-hover:scale-110 transition-transform origin-left">IA</h3>
                <p className="text-zinc-500 text-xs md:text-sm mt-1 font-medium md:group-hover:text-zinc-300 transition-colors">Videotelemetria</p>
              </div>
              <div className="group cursor-default">
                <h3 className="text-3xl md:text-4xl font-black text-cyan-400 md:group-hover:scale-110 transition-transform origin-left">LOG</h3>
                <p className="text-zinc-500 text-xs md:text-sm mt-1 font-medium md:group-hover:text-zinc-300 transition-colors">Roteirização e Entregas</p>
              </div>
              <div className="group cursor-default">
                <h3 className="text-3xl md:text-4xl font-black text-cyan-400 md:group-hover:scale-110 transition-transform origin-left">CLT</h3>
                <p className="text-zinc-500 text-xs md:text-sm mt-1 font-medium md:group-hover:text-zinc-300 transition-colors">Controle de Jornada</p>
              </div>
            </div>
          </div>

          {/* DASHBOARD MOCKUP INTERATIVO (AGORA VISÍVEL NO CELULAR) */}
          <div className="relative w-full mt-12 lg:mt-0 animate-float perspective-1000">
            <div className="absolute inset-0 bg-cyan-400/20 blur-[80px] md:blur-[120px] rounded-full animate-pulse" />
            
            <div className="relative bg-[#050B1A]/90 border border-white/10 rounded-2xl md:rounded-3xl p-4 md:p-8 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden transition-all duration-500 hover:border-cyan-400/40">
              
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-5 md:mb-6">
                <div>
                  <p className="text-cyan-400 font-bold tracking-widest text-[9px] md:text-xs mb-1 uppercase">Centro de Controle Operacional</p>
                ...
                <div className="flex items-center gap-2 text-green-400 bg-green-400/10 px-3 py-1.5 rounded-full border border-green-400/20 text-[10px] md:text-sm font-bold">
              ...
              {/* TABS INTERATIVAS */}
              <div className="flex items-center gap-2 mb-5 md:mb-6 overflow-x-auto pb-2 hide-scrollbar border-b border-white/10">
                <button 
                  onClick={() => setDashTab("visaoGeral")}
                  className={`px-3 md:px-4 py-2 rounded-full text-[10px] md:text-xs font-bold transition-all whitespace-nowrap flex items-center gap-1.5 md:gap-2 active:scale-95 ${dashTab === 'visaoGeral' ? 'bg-cyan-400 text-black shadow-[0_0_15px_rgba(34,211,238,0.4)]' : 'bg-white/5 text-zinc-400 hover:bg-white/10 hover:text-white'}`}
                >
                  <Activity size={14} /> Visão Geral
                </button>
                <button 
                  onClick={() => setDashTab("videoIA")}
                  className={`px-3 md:px-4 py-2 rounded-full text-[10px] md:text-xs font-bold transition-all whitespace-nowrap flex items-center gap-1.5 md:gap-2 active:scale-95 ${dashTab === 'videoIA' ? 'bg-cyan-400 text-black shadow-[0_0_15px_rgba(34,211,238,0.4)]' : 'bg-white/5 text-zinc-400 hover:bg-white/10 hover:text-white'}`}
                >
                  <Camera size={14} /> Câmera IA
                </button>
                <button 
                  onClick={() => setDashTab("logistica")}
                  className={`px-3 md:px-4 py-2 rounded-full text-[10px] md:text-xs font-bold transition-all whitespace-nowrap flex items-center gap-1.5 md:gap-2 active:scale-95 ${dashTab === 'logistica' ? 'bg-cyan-400 text-black shadow-[0_0_15px_rgba(34,211,238,0.4)]' : 'bg-white/5 text-zinc-400 hover:bg-white/10 hover:text-white'}`}
                >
                  <Map size={14} /> Logística
                </button>
                <button 
                  onClick={() => setDashTab("telemetria")}
                  className={`px-3 md:px-4 py-2 rounded-full text-[10px] md:text-xs font-bold transition-all whitespace-nowrap flex items-center gap-1.5 md:gap-2 active:scale-95 ${dashTab === 'telemetria' ? 'bg-cyan-400 text-black shadow-[0_0_15px_rgba(34,211,238,0.4)]' : 'bg-white/5 text-zinc-400 hover:bg-white/10 hover:text-white'}`}
                >
              ...
              {dashTab === "visaoGeral" && (
                <div className="animate-in fade-in duration-300">
                  <div className="grid grid-cols-2 gap-3 md:gap-4 mb-4 md:mb-5">
                    <div className="bg-white/5 border border-white/5 rounded-xl md:rounded-2xl p-3 md:p-5 cursor-default group">
                      <div className="flex items-center gap-2 mb-1.5 md:mb-2 opacity-70"><CheckSquare className="text-cyan-400 w-4 h-4 md:w-5 md:h-5" /><span className="text-[10px] md:text-sm font-medium">Ordens de Serviço</span></div>
                      <h4 className="text-xl md:text-4xl font-black text-white">1.248<span className="text-[10px] md:text-lg text-zinc-500 font-medium ml-1">entregas</span></h4>
                    </div>
                    <div className="bg-white/5 border border-white/5 rounded-xl md:rounded-2xl p-3 md:p-5 cursor-default group">
                      <div className="flex items-center gap-2 mb-1.5 md:mb-2 opacity-70"><Clock className="text-cyan-400 w-4 h-4 md:w-5 md:h-5" /><span className="text-[10px] md:text-sm font-medium">Jornadas Ativas</span></div>
                      <h4 className="text-xl md:text-4xl font-black text-white">142<span className="text-[10px] md:text-lg text-zinc-500 font-medium ml-1">motoristas</span></h4>
                    </div>
                    <div className="bg-white/5 border border-white/5 rounded-xl md:rounded-2xl p-3 md:p-5 cursor-default group">
                      <div className="flex items-center gap-2 mb-1.5 md:mb-2 opacity-70"><Gauge className="text-cyan-400 w-4 h-4 md:w-5 md:h-5" /><span className="text-[10px] md:text-sm font-medium">Score da Frota</span></div>
                      <h4 className="text-xl md:text-4xl font-black text-white">94<span className="text-[10px] md:text-lg text-zinc-500 font-medium ml-1">pts</span></h4>
                    </div>
                    <div className="bg-white/5 border border-white/5 rounded-xl md:rounded-2xl p-3 md:p-5 cursor-default group">
                      <div className="flex items-center gap-2 mb-1.5 md:mb-2 opacity-70"><Wrench className="text-cyan-400 w-4 h-4 md:w-5 md:h-5" /><span className="text-[10px] md:text-sm font-medium">Previsões Preventivas</span></div>
                      <h4 className="text-xl md:text-4xl font-black text-white">08<span className="text-[10px] md:text-lg text-zinc-500 font-medium ml-1">veículos</span></h4>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="bg-red-500/10 rounded-lg p-2.5 flex items-center justify-between text-[10px] md:text-sm border border-red-500/20">
                      <div className="flex items-center gap-2"><Video className="text-red-400 w-3 h-3 md:w-4 md:h-4 flex-shrink-0" /><span className="text-zinc-200 font-medium line-clamp-1">Sinal de fadiga detectado (TRK-44)</span></div>
                      <span className="text-red-400 font-bold flex items-center gap-1 flex-shrink-0"><div className="w-1.5 h-1.5 rounded-full bg-red-400 animate-pulse"/>REC</span>
                    </div>
                    <div className="bg-yellow-500/10 rounded-lg p-2.5 flex items-center justify-between text-[10px] md:text-sm border border-yellow-500/20">
                      <div className="flex items-center gap-2"><MapPinned className="text-yellow-400 w-3 h-3 md:w-4 md:h-4 flex-shrink-0" /><span className="text-zinc-300 font-medium line-clamp-1">Velocidade na Via: 58km/h (Permitido: 40km/h)</span></div>
                      <span className="text-zinc-500 flex-shrink-0">Há 2 min</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {dashTab === "videoIA" && (
                <div className="animate-in fade-in duration-300">
                  <div className="grid grid-cols-3 gap-2 md:gap-3 mb-4 md:mb-5">
                    <div className="bg-white/5 border border-white/5 rounded-xl p-3 md:p-4 text-center">
                      <Camera className="text-cyan-400 w-5 h-5 md:w-6 md:h-6 mx-auto mb-1 md:mb-2" />
                      <h4 className="text-xl md:text-2xl font-black text-white">42</h4>
                      <span className="text-[9px] md:text-xs text-zinc-500">Câmeras Online</span>
                    </div>
                    <div className="bg-white/5 border border-white/5 rounded-xl p-3 md:p-4 text-center">
                      <Eye className="text-yellow-400 w-5 h-5 md:w-6 md:h-6 mx-auto mb-1 md:mb-2" />
                      <h4 className="text-xl md:text-2xl font-black text-white">04</h4>
                      <span className="text-[9px] md:text-xs text-zinc-500">Eventos Distração</span>
                    </div>
                    <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-3 md:p-4 text-center">
                      <Bell className="text-red-400 w-5 h-5 md:w-6 md:h-6 mx-auto mb-1 md:mb-2" />
                      <h4 className="text-xl md:text-2xl font-black text-white">01</h4>
                      <span className="text-[9px] md:text-xs text-red-400 font-bold">Fadiga Severa</span>
                    </div>
                  </div>
                  {/* VIDEO REAL EMBUTIDO */}
                  <div className="bg-black rounded-2xl border border-white/10 relative h-36 md:h-48 flex flex-col items-center justify-center overflow-hidden shadow-inner">
                     ...
                     <div className="absolute top-2 left-2 md:top-3 md:left-3 text-red-400 text-[8px] md:text-[10px] font-bold flex items-center gap-1.5 bg-black/60 px-2 py-1 rounded backdrop-blur-sm border border-white/10 z-10">
                       <div className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-red-400 animate-pulse"/> LIVE FEED: CABINE IA
                     </div>
                     <span className="relative z-10 mt-auto mb-3 md:mb-4 text-white text-[8px] md:text-[10px] font-bold bg-black/70 px-3 py-1 md:py-1.5 rounded-full border border-cyan-400/30 backdrop-blur-md">
                ...
                <div className="animate-in fade-in duration-300">
                  <div className="grid grid-cols-2 gap-2 md:gap-3 mb-4">
                    <div className="bg-white/5 border border-white/5 rounded-xl md:rounded-2xl p-3 md:p-4">
                      <div className="flex items-center gap-1.5 md:gap-2 mb-1 opacity-70"><CheckCircle2 className="text-green-400 w-4 h-4" /><span className="text-[10px] md:text-xs font-medium">Entregas no Prazo</span></div>
                      <h4 className="text-xl md:text-2xl font-black text-white">96<span className="text-[10px] md:text-xs text-zinc-500 font-medium ml-1">%</span></h4>
                    </div>
                    <div className="bg-white/5 border border-white/5 rounded-xl md:rounded-2xl p-3 md:p-4">
                      <div className="flex items-center gap-1.5 md:gap-2 mb-1 opacity-70"><Truck className="text-cyan-400 w-4 h-4" /><span className="text-[10px] md:text-xs font-medium">Veículos em Rota</span></div>
                      <h4 className="text-xl md:text-2xl font-black text-white">18</h4>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#0b101e] rounded-xl md:rounded-2xl border border-white/10 relative h-36 md:h-48 overflow-hidden">
                    ...
                    <div className="absolute top-2 left-2 md:top-3 md:left-3 text-cyan-400 text-[8px] md:text-[10px] font-bold flex items-center gap-1.5 bg-black/60 backdrop-blur-sm px-2 py-1 rounded border border-white/10">
                    ...
                    <div className="absolute top-[75%] left-[25%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                       <MapPinned className="text-white w-3 h-3 md:w-4 md:h-4 drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
                       <span className="text-[6px] md:text-[7px] font-bold text-white mt-1 bg-black/80 px-1 rounded">CD CENTRAL</span>
                    </div>

                    <div className="absolute top-[25%] left-[85%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                       <div className="w-2.5 h-2.5 md:w-3 md:h-3 bg-cyan-400 rounded-full flex items-center justify-center shadow-[0_0_10px_rgba(34,211,238,0.8)] animate-pulse">
                         <div className="w-1 h-1 md:w-1.5 md:h-1.5 bg-black rounded-full" />
                       </div>
                       <span className="text-[6px] md:text-[7px] font-bold text-cyan-300 mt-1 bg-black/80 px-1 rounded">CLIENTE #44</span>
                    </div>

                    <div className="absolute top-[40%] left-[62%] -translate-x-1/2 -translate-y-1/2 animate-[bounce_1s_infinite]">
                       <Truck className="text-green-400 w-4 h-4 md:w-5 md:h-5 drop-shadow-[0_0_10px_rgba(74,222,128,1)]" />
                    </div>
                  </div>
                </div>
              )}
              ...
              {dashTab === "telemetria" && (
                <div className="animate-in fade-in duration-500">
                  <div className="grid grid-cols-3 gap-2 md:gap-3 mb-4">
                    <div className="bg-white/5 border border-white/5 rounded-xl p-2 md:p-3 text-center">
                      <TrendingUp className="text-green-400 w-4 h-4 md:w-5 md:h-5 mx-auto mb-1" />
                      <h4 className="text-lg md:text-xl font-black text-white">4.8 <span className="text-[8px] md:text-[10px] text-zinc-500 font-normal">Km/L</span></h4>
                    </div>
                    <div className="bg-white/5 border border-white/5 rounded-xl p-2 md:p-3 text-center">
                      <Gauge className="text-cyan-400 w-4 h-4 md:w-5 md:h-5 mx-auto mb-1" />
                      <h4 className="text-lg md:text-xl font-black text-white">96 <span className="text-[8px] md:text-[10px] text-zinc-500 font-normal">Pts</span></h4>
                    </div>
                    <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-2 md:p-3 text-center">
                      <AlertTriangle className="text-red-400 w-4 h-4 md:w-5 md:h-5 mx-auto mb-1 animate-pulse" />
                      <h4 className="text-lg md:text-xl font-black text-red-400">12 <span className="text-[8px] md:text-[10px] font-normal">Riscos</span></h4>
                    </div>
                  </div>
                  
                  {/* Gráficos de Infração */}
                  <div className="bg-black/40 rounded-xl md:rounded-2xl border border-white/5 p-3 flex flex-col justify-center shadow-inner h-[130px] md:h-[150px]">
                    <div className="flex justify-between items-center mb-2 md:mb-3">
                      <span className="text-[8px] md:text-[10px] font-bold text-zinc-400 tracking-wider flex items-center gap-1.5">
                        <Activity size={12} className="text-cyan-400"/> ANÁLISE DE CONDUÇÃO (FROTA)
                      </span>
                    </div>
                    
                    <div className="space-y-2 md:space-y-2.5">
                      <div>
                        <div className="flex justify-between text-[8px] md:text-[9px] mb-1 uppercase font-medium">
      ...
      <section id="ecossistema" className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-32 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
          {funcionalidades.map((item, index) => (
            <div
              key={index}
              className="group bg-white/5 border border-white/10 rounded-2xl md:rounded-[32px] p-6 md:p-8 active:scale-95 md:hover:bg-gradient-to-b md:hover:from-white/10 md:hover:to-transparent md:hover:border-cyan-400/50 md:hover:shadow-[0_0_30px_rgba(34,211,238,0.15)] md:hover:-translate-y-2 transition-all duration-500"
            >
