      ...
      <div className="bg-[#020817] text-white min-h-screen py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <button
            ...
            className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 font-bold mb-8 md:mb-12 transition group cursor-pointer"
          >
          ...
          <button
            onClick={() => alternarDocumento(null)}
            className="w-full md:w-auto flex items-center justify-center gap-2 bg-white/5 border border-white/10 hover:border-cyan-400/30 hover:bg-white/10 px-6 py-4 md:py-3 rounded-xl font-bold mt-12 mb-8 transition cursor-pointer"
          >
  ...
  return (
    <div className="bg-[#020817] text-white overflow-x-hidden font-sans">
      ...
      <div className="fixed inset-0 opacity-20 pointer-events-none">
        <div className="absolute top-0 left-1/2 md:left-1/3 w-[300px] md:w-[700px] h-[300px] md:h-[700px] bg-cyan-400 blur-[120px] md:blur-[180px] -translate-x-1/2 md:-translate-x-0" />
        <div className="absolute bottom-0 right-0 md:right-1/3 w-[300px] md:w-[700px] h-[300px] md:h-[700px] bg-blue-700 blur-[120px] md:blur-[180px]" />
      </div>

      {/* HEADER NAVBAR */}
      <header className="fixed top-0 left-0 w-full z-50 border-b border-white/10 backdrop-blur-xl bg-[#020817]/80">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3 md:gap-4">
            <img src={logo} alt="ORIONSAT" className="w-10 h-10 md:w-14 md:h-14 object-contain" translate="no" />
            <div translate="no">
              <h1 className="font-black text-xl md:text-3xl tracking-tight leading-none">ORIONSAT</h1>
          ...
          <nav className="hidden lg:flex items-center gap-10 text-sm font-medium text-zinc-300">
            ...
            <a href="#plataforma" className="hover:text-cyan-400 transition-colors">Plataforma</a>
          ...
          <a
            ...
            className="bg-cyan-400 hover:bg-cyan-300 text-black px-4 md:px-7 py-2 md:py-3 rounded-xl md:rounded-2xl font-bold text-sm md:text-base transition-transform hover:scale-105 active:scale-95"
          >
            Comercial
          </a>
        </div>
      ...
      {/* HERO SECTION */}
      <section className="min-h-[100dvh] flex items-center pt-28 md:pt-36 pb-20 relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-12 md:gap-24 items-center relative z-10 w-full">
          {/* Hero Texto */}
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 md:gap-3 px-4 py-2 md:px-5 md:py-3 rounded-full border border-cyan-400/20 bg-cyan-400/5 text-cyan-300 text-xs md:text-sm mb-8 mx-auto lg:mx-0 font-medium">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-8xl font-black leading-[1.05] md:leading-[0.95] tracking-tight">
              Visibilidade
              <span className="text-cyan-400 block mt-2">operacional total.</span>
              Inteligência
              <span className="text-cyan-400 block mt-2">que gera economia.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 md:gap-5 mt-10">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto bg-cyan-400 hover:bg-cyan-300 text-black px-8 py-4 md:py-5 rounded-2xl font-bold flex items-center justify-center gap-3 transition-transform hover:scale-105 active:scale-95"
              >
                Solicitar acesso
                <ArrowRight size={20} />
              </a>
              <a
                href="#plataforma"
                className="w-full sm:w-auto border border-white/10 hover:border-cyan-400/40 hover:bg-white/5 px-8 py-4 md:py-5 rounded-2xl transition-colors font-medium text-center"
              >
                Explorar recursos
              </a>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8 pt-12 border-t border-white/10 mt-12 max-w-lg mx-auto lg:mx-0">
              <div>
                <h3 className="text-3xl md:text-4xl font-black text-cyan-400">24/7</h3>
                <p className="text-zinc-500 text-xs md:text-sm mt-1 font-medium">Monitoramento ativo</p>
              </div>
              <div>
                <h3 className="text-3xl md:text-4xl font-black text-cyan-400">IoT</h3>
                <p className="text-zinc-500 text-xs md:text-sm mt-1 font-medium">Conectividade M2M</p>
              </div>
              <div>
                <h3 className="text-3xl md:text-4xl font-black text-cyan-400">API</h3>
                <p className="text-zinc-500 text-xs md:text-sm mt-1 font-medium">Integração nativa</p>
              </div>
            </div>
          </div>

          {/* DASHBOARD MOCKUP - REFORMULADO PARA TELEMETRIA */}
          <div className="relative w-full mt-10 lg:mt-0">
            <div className="absolute inset-0 bg-cyan-400/20 blur-[80px] md:blur-[120px] rounded-full" />
            <div className="relative bg-[#050B1A]/80 border border-white/10 rounded-3xl md:rounded-[36px] p-5 md:p-8 backdrop-blur-2xl shadow-2xl overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                ...
                <div className="flex items-center gap-2 text-green-400 bg-green-400/10 px-3 py-1.5 rounded-full border border-green-400/20 text-xs md:text-sm font-bold">
                  <div className="w-2 h-2 md:w-2.5 md:h-2.5 rounded-full bg-green-400 animate-pulse shadow-[0_0_10px_rgba(74,222,128,0.5)]" />
                  SISTEMA ONLINE
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4 mb-5">
                <div className="bg-white/5 border border-white/5 rounded-2xl p-4 md:p-5 hover:bg-white/10 transition-colors">
                  <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3 opacity-70">
                    <Car className="text-cyan-400 w-5 h-5 md:w-6 md:h-6" />
                    <span className="text-xs md:text-sm font-medium">Frotas Ativas</span>
                  </div>
                  <h4 className="text-2xl md:text-4xl font-black tracking-tight text-white">248<span className="text-sm md:text-lg text-zinc-500 font-medium tracking-normal ml-1">/250</span></h4>
                </div>
                ...
                <div className="bg-white/5 border border-white/5 rounded-2xl p-4 md:p-5 hover:bg-white/10 transition-colors">
                  ...
                  <h4 className="text-2xl md:text-4xl font-black tracking-tight text-white">4.2<span className="text-sm md:text-lg text-zinc-500 font-medium tracking-normal ml-1">avg</span></h4>
                </div>
                ...
                <div className="bg-white/5 border border-white/5 rounded-2xl p-4 md:p-5 hover:bg-white/10 transition-colors">
                  ...
                  <h4 className="text-2xl md:text-4xl font-black tracking-tight text-white">96<span className="text-sm md:text-lg text-zinc-500 font-medium tracking-normal ml-1">%</span></h4>
                </div>
              ...
              <div className="bg-[#02050A] rounded-2xl border border-white/10 p-1 relative overflow-hidden h-40 md:h-48 group">
                <div className="absolute inset-0 opacity-[0.15] bg-[linear-gradient(rgba(255,255,255,1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,1)_1px,transparent_1px)] bg-[size:20px_20px] md:bg-[size:30px_30px]" />
                <div className="absolute top-3 left-4 text-[10px] md:text-xs font-bold text-zinc-500 tracking-wider flex items-center gap-2 z-10 bg-black/50 px-2 py-1 rounded">
                  <MapPinned size={14} className="text-cyan-400" />
                  RASTREAMENTO AO VIVO
                </div>
                
                {/* Carrinhos simulados no mapa */}
                <div className="absolute top-1/2 left-1/4 -translate-y-1/2 flex flex-col items-center">
                  ...
                  <span className="text-[8px] font-bold text-cyan-300 mt-1 bg-black/60 px-1.5 rounded">RTA-01</span>
                </div>
                ...
                <div className="absolute top-1/4 right-1/3 flex flex-col items-center">
                  <div className="w-8 h-8 rounded-full bg-cyan-400/20 flex items-center justify-center animate-[pulse_2.5s_ease-in-out_infinite]">
                    <Navigation2 size={14} className="text-cyan-400 fill-cyan-400 rotate-45" />
                  </div>
                  <span className="text-[8px] font-bold text-cyan-300 mt-1 bg-black/60 px-1.5 rounded">TRK-99</span>
                </div>
                ...
                <div className="absolute bottom-1/4 right-1/4 flex flex-col items-center">
                  ...
                  <span className="text-[8px] font-bold text-red-300 mt-1 bg-black/60 px-1.5 rounded text-center">OVR-SPD<br/>110km/h</span>
                </div>
              </div>

              {/* Log de Eventos Rápido */}
              <div className="mt-4 md:mt-5 space-y-2">
                <div className="bg-white/5 rounded-lg p-2.5 md:p-3 flex items-center justify-between text-xs md:text-sm border border-white/5">
                  <div className="flex items-center gap-2 md:gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400" />
                    <span className="text-zinc-300 font-medium">Excesso de Velocidade detectado</span>
                  </div>
                  <span className="text-zinc-500 text-[10px] md:text-xs">Agora</span>
                </div>
                <div className="bg-white/5 rounded-lg p-2.5 md:p-3 flex items-center justify-between text-xs md:text-sm border border-white/5">
                  <div className="flex items-center gap-2 md:gap-3">
      ...
      {/* SEÇÃO DE SOBRE/VANTAGENS */}
      <section id="sobre" className="max-w-7xl mx-auto px-4 md:px-6 py-20 md:py-32">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
          <div>
            <p className="text-cyan-400 font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] text-xs md:text-sm mb-4 md:mb-5">
      ...
      {/* FUNCIONALIDADES */}
      <section id="plataforma" className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-32">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
          {funcionalidades.map((item, index) => (
            <div
              key={index}
              className="bg-white/5 border border-white/10 rounded-2xl md:rounded-[32px] p-6 md:p-8 hover:border-cyan-400/40 hover:bg-white/10 transition-all duration-300"
            >
              <div className="text-cyan-400 mb-5 md:mb-6 bg-cyan-400/10 w-fit p-3 md:p-4 rounded-xl md:rounded-2xl">
                {item.icon}
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-32">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
          {segmentos.map((item, index) => (
            <div
              key={index}
              className="bg-white/5 border border-white/10 rounded-xl md:rounded-3xl p-5 md:p-8 hover:border-cyan-400/30 hover:bg-white/10 transition-colors flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4"
            >
              <RouteIcon className="text-cyan-400 flex-shrink-0" size={28} />
      ...
      {/* TECNOLOGIA E BENEFÍCIOS (JUNTOS PARA MELHORAR LAYOUT MOBILE) */}
      <section id="tecnologia" className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-32">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-5">
              {[
                ...
                <div key={index} className="bg-white/5 border border-white/10 rounded-xl md:rounded-2xl p-5 md:p-6 text-center hover:bg-white/10 transition-colors">
                  <div className="flex justify-center text-cyan-400 mb-3 md:mb-4 bg-cyan-400/10 w-fit p-3 rounded-full mx-auto">{item.icon}</div>
          ...
          <div>
            ...
            <div className="space-y-3 md:space-y-4">
              {beneficios.map((item, index) => (
                <div key={index} className="bg-white/5 border border-white/10 rounded-xl md:rounded-2xl p-4 md:p-5 flex items-center gap-4 hover:border-cyan-400/20 transition-colors">
                  <CheckCircle2 className="text-cyan-400 flex-shrink-0" size={24} />
                  <p className="text-sm md:text-lg text-zinc-300 font-medium">{item}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* CLIENTES */}
      <section id="clientes" className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-32">
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-5">
          {empresas.map((empresa, index) => (
            <div
              key={index}
              className="bg-white/5 border border-white/10 rounded-xl md:rounded-2xl px-6 py-4 md:px-8 md:py-6 text-center hover:border-cyan-400/30 hover:bg-white/10 transition-colors flex-grow max-w-[200px] md:max-w-[240px]"
            >
      ...
      {/* FAQ */}
      <section id="faq" className="max-w-4xl mx-auto px-4 md:px-6 pb-20 md:pb-32">
        <div className="text-center mb-12 md:mb-16">
      ...
      {/* CTA SECTION */}
      <section className="max-w-7xl mx-auto px-4 md:px-6 pb-20 md:pb-32">
        <div className="relative overflow-hidden bg-gradient-to-br from-cyan-900/40 to-blue-900/40 border border-cyan-400/20 rounded-3xl md:rounded-[40px] p-8 md:p-16 text-center">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-cyan-400/10 blur-[100px] pointer-events-none" />
          
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black max-w-4xl mx-auto leading-[1.1] tracking-tight">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 w-full sm:w-auto bg-cyan-400 hover:bg-cyan-300 text-black px-8 py-4 md:py-5 rounded-xl md:rounded-2xl font-bold mt-10 transition-transform hover:scale-105 active:scale-95 text-base md:text-lg"
            >
      ...
      {/* FOOTER */}
      <footer className="border-t border-white/10 py-12 md:py-16 bg-black/20">
        <div className="max-w-7xl mx-auto px-4 md:px-6 grid sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
          <div className="sm:col-span-2 lg:col-span-2">
            <div className="flex items-center gap-3 md:gap-4 mb-5 md:mb-6">
              ...
              <div>
                <h3 className="font-black text-2xl md:text-3xl tracking-tight">ORIONSAT</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3 text-zinc-400 text-sm md:text-base">
              <li className="hover:text-cyan-400 cursor-pointer transition-colors">Telemetria Avançada</li>
              <li className="hover:text-cyan-400 cursor-pointer transition-colors">Roteirização Logística</li>
              <li className="hover:text-cyan-400 cursor-pointer transition-colors">Dashboard Analítico</li>
              <li className="hover:text-cyan-400 cursor-pointer transition-colors">Aplicativo Mobile</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3 text-zinc-400 text-sm md:text-base">
              ...
              <li>(11) 91102-1692</li>
              <li className="break-words">comercial@orionsatgestao.com.br</li>
            </ul>
          </div>
        </div>
